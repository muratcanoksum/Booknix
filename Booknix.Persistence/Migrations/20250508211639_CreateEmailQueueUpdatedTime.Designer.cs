...
namespace Booknix.Persistence.Migrations
{
    ...
    [Migration("20250508211639_CreateEmailQueueUpdatedTime")]
    partial class CreateEmailQueueUpdatedTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.EmailQueue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.Worker", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.WorkerWorkingHour", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.Worker", b =>
                {
                    ...
                    b.HasOne("Booknix.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Booknix.Domain.Entities.Worker", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Booknix.Domain.Entities.Worker", b =>
                {
                    b.Navigation("WorkerWorkingHours");
                });
